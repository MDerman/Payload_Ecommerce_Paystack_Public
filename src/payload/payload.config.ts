      ...
      return {
        ...
        resolve: {
          ...
          alias: {
            ...
            [path.resolve(__dirname, './email/transport')]: mockModulePath,
            [path.resolve(__dirname, './email/generateEmailHTML')]: mockModulePath,
            [path.resolve(__dirname, './email/generateForgotPasswordEmail')]: mockModulePath,
            [path.resolve(__dirname, './email/generateVerificationEmail')]: mockModulePath,
